...
public class NConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureBootstrapContext) {
        ...
        register(featureBootstrapContext, PATCH_SOUL_BERRY_BUSH, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(NBlocks.SOUL_BERRY_BUSH.defaultBlockState().setValue(SoulBerryBushBlock.AGE, 3))));
        register(featureBootstrapContext, PATCH_CINDER_GRASS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(NBlocks.CINDER_GRASS)));
    }
