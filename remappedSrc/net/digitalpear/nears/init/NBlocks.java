...
public class NBlocks {
    ...
    public static final Block NEAR_BULB = createBlockWithoutItem("near_bulb",
            new NearBulbBlock(AbstractBlock.Settings.of(Material.NETHER_SHOOTS, state ->
                            state.get(NearBulbBlock.AGE) < NearBulbBlock.MAX_AGE ? MapColor.RED : MapColor.PURPLE)
